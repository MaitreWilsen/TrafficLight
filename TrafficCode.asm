Author : Wilsen Maitre
Purpose: The project will simulate a traffic light. 4 led: red, yellow, green, and
white. Red, yellow and green When the button is pressed it will start the process for the crosswalk light.
